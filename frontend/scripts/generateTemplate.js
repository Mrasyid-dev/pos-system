// Script untuk generate template Excel
// Run dengan: node scripts/generateTemplate.js
...
async function generateTemplate() {
  ...
  const filePath = path.join(templatesDir, 'report-template.xlsx');
  await workbook.xlsx.writeFile(filePath);
  
  console.log('✅ Template Excel berhasil dibuat!');
  console.log(`📁 Lokasi: ${filePath}`);
  console.log('\nTemplate siap digunakan untuk export report.');
}
